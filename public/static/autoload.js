try {
    if (!isMobileBrowser()) {
        $("<link>").attr({href: "/static/waifu.min.css?v=1.4.2", rel: "stylesheet", type: "text/css"}).appendTo('head');
        ...
        $.ajax({url: '/static/waifu-tips.min.js?v=1.4.2', dataType: "script", cache: true, async: false});
        $.ajax({url: '/static/live2d.min.js?v=1.0.5', dataType: "script", cache: true, async: false});
        /* 可直接修改部分参数 */
