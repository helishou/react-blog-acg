...
import { getTime,loginGithubHandel, config ,getToken, getAvatar, getName,openWindow} from '@/lib/utils';
                ...
                <ul className="commentwrap">
                    {commentsList.map((item, index) => {
                      ...
                      {getFormatTime(item.create_time)} */}
                                    ...
                                    <span
                                        onClick={() => this.reply(item._id, item.user.name, item.user.user_id)}
